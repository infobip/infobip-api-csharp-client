...
namespace Infobip.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RcsRegionalOptions")]
    [JsonObject]
    public class RcsRegionalOptions : IEquatable<RcsRegionalOptions>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="RcsRegionalOptions" /> class.
        /// </summary>
        /// <param name="indiaDlt">indiaDlt.</param>
        /// <param name="turkeyIys">turkeyIys.</param>
        /// <param name="southKorea">southKorea.</param>
        public RcsRegionalOptions(RcsIndiaDltOptions indiaDlt = default, TurkeyIysOptions turkeyIys = default,
            RcsSouthKoreaOptions southKorea = default)
        {
            IndiaDlt = indiaDlt;
            TurkeyIys = turkeyIys;
        ...
        public RcsIndiaDltOptions IndiaDlt { get; set; }
        ...
        public RcsSouthKoreaOptions SouthKorea { get; set; }

        /// <summary>
        ///     Returns true if RcsRegionalOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of RcsRegionalOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RcsRegionalOptions input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RcsRegionalOptions {\n");
        ...
        {
            return Equals(input as RcsRegionalOptions);
        }
