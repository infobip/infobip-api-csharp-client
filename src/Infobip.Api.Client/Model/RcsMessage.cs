...
namespace Infobip.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RcsMessage")]
    [JsonObject]
    public class RcsMessage : IEquatable<RcsMessage>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="RcsMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RcsMessage()
        {
        }
        ...
        ///     Initializes a new instance of the <see cref="RcsMessage" /> class.
        /// </summary>
        /// <param name="sender">Identifier of an RCS sender that will be used to send message..</param>
        ...
        public RcsMessage(string sender = default, List<RcsToDestination> destinations = default,
            RcsOutboundMessageContent content = default, RcsFailoverOptions options = default,
            RcsAdvancedWebhooksWithSeen webhooks = default)
        {
        ...
        public RcsOutboundMessageContent Content { get; set; }
        ...
        public RcsFailoverOptions Options { get; set; }
        ...
        public RcsAdvancedWebhooksWithSeen Webhooks { get; set; }

        /// <summary>
        ///     Returns true if RcsMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of RcsMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RcsMessage input)
        {
            if (input == null)
                return false;
        ...
        {
            return Equals(input as RcsMessage);
        }
