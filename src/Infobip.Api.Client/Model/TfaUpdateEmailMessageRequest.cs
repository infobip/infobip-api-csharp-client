...
namespace Infobip.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TfaUpdateEmailMessageRequest")]
    [JsonObject]
    public class TfaUpdateEmailMessageRequest : IEquatable<TfaUpdateEmailMessageRequest>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="TfaUpdateEmailMessageRequest" /> class.
        /// </summary>
        ...
        [JsonProperty(PropertyName = "emailTemplateId", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        /// <summary>
        ///     Returns true if TfaUpdateEmailMessageRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TfaUpdateEmailMessageRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TfaUpdateEmailMessageRequest input)
        {
            if (input == null)
                return false;
        ...
        {
            return Equals(input as TfaUpdateEmailMessageRequest);
        }
