...
namespace Infobip.Api.Client.Model
{
    ...
    ///     EmailResult
    /// </summary>
    [DataContract(Name = "EmailResult")]
    [JsonObject]
    public class EmailResult : IEquatable<EmailResult>
    {
        /// <summary>
        ...
        public EmailResult(string bulkId = default, EmailPriceInfo price = default, MessageStatus status = default,
            ...
            string callbackData = default, string to = default, string campaignReferenceId = default,
            string entityId = default, string applicationId = default)
        {
            BulkId = bulkId;
            Price = price;
            Status = status;
        ...
        public EmailPriceInfo Price { get; set; }
        ...
        public EmailErrorInfo Error { get; set; }
        ...
        /// <summary>
        ///     Returns true if EmailResult instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailResult input)
        {
            if (input == null)
                return false;
        ...
        {
            return Equals(input as EmailResult);
        }
