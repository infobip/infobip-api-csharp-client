...
namespace Infobip.Api.Client.Model
{
    ...
    ///     India.
    /// </summary>
    [DataContract(Name = "RcsIndiaDltOptions")]
    [JsonObject]
    public class RcsIndiaDltOptions : IEquatable<RcsIndiaDltOptions>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="RcsIndiaDltOptions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RcsIndiaDltOptions()
        {
        }
        ...
        public RcsIndiaDltOptions(string contentTemplateId = default, string principalEntityId = default,
        ...
        /// <summary>
        ///     Returns true if RcsIndiaDltOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of RcsIndiaDltOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RcsIndiaDltOptions input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RcsIndiaDltOptions {\n");
        ...
        {
            return Equals(input as RcsIndiaDltOptions);
        }
