...
namespace Infobip.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RcsSouthKoreaOptions")]
    [JsonObject]
    public class RcsSouthKoreaOptions : IEquatable<RcsSouthKoreaOptions>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="RcsSouthKoreaOptions" /> class.
        /// </summary>
        ...
        /// </param>
        public RcsSouthKoreaOptions(string title = default, int resellerCode = default)
        {
            Title = title;
        ...
        /// <summary>
        ///     Returns true if RcsSouthKoreaOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of RcsSouthKoreaOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RcsSouthKoreaOptions input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RcsSouthKoreaOptions {\n");
        ...
        {
            return Equals(input as RcsSouthKoreaOptions);
        }
