...
namespace Infobip.Api.Client.Model
{
    ...
    ///     CallsPlayOptions
    /// </summary>
    [DataContract(Name = "CallsPlayOptions")]
    [JsonObject]
    public class CallsPlayOptions : IEquatable<CallsPlayOptions>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="CallsPlayOptions" /> class.
        /// </summary>
        /// <param name="loopCount">Number of times the file will be played..</param>
        public CallsPlayOptions(int loopCount = default)
        {
            LoopCount = loopCount;
        }
        ...
        /// <summary>
        ///     Returns true if CallsPlayOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of CallsPlayOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallsPlayOptions input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallsPlayOptions {\n");
        ...
        {
            return Equals(input as CallsPlayOptions);
        }
