...
namespace Infobip.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MessagesApiRegionalOptions")]
    [JsonObject]
    public class MessagesApiRegionalOptions : IEquatable<MessagesApiRegionalOptions>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="MessagesApiRegionalOptions" /> class.
        /// </summary>
        /// <param name="indiaDlt">indiaDlt.</param>
        /// <param name="turkeyIys">turkeyIys.</param>
        /// <param name="southKorea">southKorea.</param>
        public MessagesApiRegionalOptions(MessagesApiIndiaDltOptions indiaDlt = default,
            TurkeyIysOptions turkeyIys = default, MessagesApiSouthKoreaOptions southKorea = default)
        {
            IndiaDlt = indiaDlt;
            TurkeyIys = turkeyIys;
        ...
        public MessagesApiIndiaDltOptions IndiaDlt { get; set; }
        ...
        public MessagesApiSouthKoreaOptions SouthKorea { get; set; }

        /// <summary>
        ///     Returns true if MessagesApiRegionalOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of MessagesApiRegionalOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessagesApiRegionalOptions input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessagesApiRegionalOptions {\n");
        ...
        {
            return Equals(input as MessagesApiRegionalOptions);
        }
