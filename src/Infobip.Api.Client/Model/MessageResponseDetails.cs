...
namespace Infobip.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MessageResponseDetails")]
    [JsonObject]
    public class MessageResponseDetails : IEquatable<MessageResponseDetails>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="MessageResponseDetails" /> class.
        /// </summary>
        ...
        /// <param name="details">Other details of the message..</param>
        public MessageResponseDetails(string messageId = default, MessageStatus status = default,
            string destination = default, object details = default)
        {
            MessageId = messageId;
            Status = status;
        ...
        /// </summary>
        /// <value>Other details of the message.</value>
        ...
        /// <summary>
        ///     Returns true if MessageResponseDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageResponseDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageResponseDetails input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessageResponseDetails {\n");
        ...
        {
            return Equals(input as MessageResponseDetails);
        }
