...
namespace Infobip.Api.Client.Model
{
    ...
    public class EmailStatus : IEquatable<EmailStatus>
    {
        /// <summary>
        ...
        public EmailStatus(int groupId = default(int), string groupName = default(string), int id = default(int),
            string name = default(string), string description = default(string), string action = default(string))
        {
            GroupId = groupId;
            GroupName = groupName;
            Id = id;
        ...
        {
            return Equals(input as EmailStatus);
        }
