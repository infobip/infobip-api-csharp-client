...
namespace Infobip.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MessagesApiOutboundTypingStartedEvent")]
    [JsonObject]
    public class MessagesApiOutboundTypingStartedEvent : MessagesApiOutboundEvent,
        IEquatable<MessagesApiOutboundTypingStartedEvent>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="MessagesApiOutboundTypingStartedEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessagesApiOutboundTypingStartedEvent()
        {
        }
        ...
        /// <param name="event">@event (required) (default to MessagesApiOutboundEventType.TypingStarted).</param>
        public MessagesApiOutboundTypingStartedEvent(MessagesApiOutboundTypingStartedEventChannel channel = default,
            string sender = default, List<MessagesApiToDestination> destinations = default,
            MessagesApiEventOptions options = default,
            MessagesApiOutboundEventType @event = MessagesApiOutboundEventType.TypingStarted) : base(@event)
        {
            Channel = channel;
        ...
        public MessagesApiOutboundTypingStartedEventChannel Channel { get; set; }
        ...
        /// <summary>
        ///     Returns true if MessagesApiOutboundTypingStartedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of MessagesApiOutboundTypingStartedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessagesApiOutboundTypingStartedEvent input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessagesApiOutboundTypingStartedEvent {\n");
        ...
        {
            return Equals(input as MessagesApiOutboundTypingStartedEvent);
        }
