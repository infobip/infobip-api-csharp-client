...
namespace Infobip.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RecipientInfo")]
    [JsonObject]
    public class RecipientInfo : IEquatable<RecipientInfo>
    {
        /// <summary>
        ...
        public RecipientInfo(string deviceType = default, string os = default, string deviceName = default)
        {
        ...
        {
            return Equals(input as RecipientInfo);
        }
