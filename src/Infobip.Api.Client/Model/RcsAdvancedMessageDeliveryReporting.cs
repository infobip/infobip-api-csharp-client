...
namespace Infobip.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RcsAdvancedMessageDeliveryReporting")]
    [JsonObject]
    public class RcsAdvancedMessageDeliveryReporting : IEquatable<RcsAdvancedMessageDeliveryReporting>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="RcsAdvancedMessageDeliveryReporting" /> class.
        /// </summary>
        /// <param name="url">
        ...
        ///     &#x60;..
        /// </param>
        public RcsAdvancedMessageDeliveryReporting(string url = default, bool intermediateReport = default,
            bool notify = default, bool receiveTriggeredFailoverReports = default)
        {
            Url = url;
        ...
        /// <summary>
        ///     Returns true if RcsAdvancedMessageDeliveryReporting instances are equal
        /// </summary>
        /// <param name="input">Instance of RcsAdvancedMessageDeliveryReporting to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RcsAdvancedMessageDeliveryReporting input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RcsAdvancedMessageDeliveryReporting {\n");
        ...
        {
            return Equals(input as RcsAdvancedMessageDeliveryReporting);
        }
