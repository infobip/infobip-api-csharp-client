...
namespace Infobip.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RcsLogsResult")]
    [JsonObject]
    public class RcsLogsResult : IEquatable<RcsLogsResult>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="RcsLogsResult" /> class.
        /// </summary>
        ...
        public RcsLogsResult(string sender = default, string destination = default, string bulkId = default,
            string messageId = default, DateTimeOffset sentAt = default, DateTimeOffset doneAt = default,
            int messageCount = default, MessagePrice price = default, MessageStatus status = default,
            MessageError error = default, Platform platform = default, RcsOutboundMessageContent content = default,
        ...
        /// <summary>
        ///     Returns true if RcsLogsResult instances are equal
        /// </summary>
        /// <param name="input">Instance of RcsLogsResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RcsLogsResult input)
        {
            if (input == null)
                return false;
        ...
        {
            return Equals(input as RcsLogsResult);
        }
