...
namespace Infobip.Api.Client.Model
{
    ...
    ///     India.
    /// </summary>
    [DataContract(Name = "MessagesApiIndiaDltOptions")]
    [JsonObject]
    public class MessagesApiIndiaDltOptions : IEquatable<MessagesApiIndiaDltOptions>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="MessagesApiIndiaDltOptions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessagesApiIndiaDltOptions()
        {
        }
        ...
        public MessagesApiIndiaDltOptions(string contentTemplateId = default, string principalEntityId = default,
        ...
        /// <summary>
        ///     Returns true if MessagesApiIndiaDltOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of MessagesApiIndiaDltOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessagesApiIndiaDltOptions input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessagesApiIndiaDltOptions {\n");
        ...
        {
            return Equals(input as MessagesApiIndiaDltOptions);
        }
