...
namespace Infobip.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RcsMoMessagePrice")]
    [JsonObject]
    public class RcsMoMessagePrice : IEquatable<RcsMoMessagePrice>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="RcsMoMessagePrice" /> class.
        /// </summary>
        ...
        public RcsMoMessagePrice(RcsMoTrafficType? trafficType = default, decimal pricePerMessage = default,
        ...
        public RcsMoTrafficType? TrafficType { get; set; }
        ...
        /// <summary>
        ///     Returns true if RcsMoMessagePrice instances are equal
        /// </summary>
        /// <param name="input">Instance of RcsMoMessagePrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RcsMoMessagePrice input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RcsMoMessagePrice {\n");
        ...
        {
            return Equals(input as RcsMoMessagePrice);
        }
