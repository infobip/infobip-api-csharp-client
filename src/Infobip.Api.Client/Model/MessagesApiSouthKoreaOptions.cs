...
namespace Infobip.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MessagesApiSouthKoreaOptions")]
    [JsonObject]
    public class MessagesApiSouthKoreaOptions : IEquatable<MessagesApiSouthKoreaOptions>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="MessagesApiSouthKoreaOptions" /> class.
        /// </summary>
        ...
        /// </param>
        public MessagesApiSouthKoreaOptions(string title = default, int resellerCode = default)
        {
            Title = title;
        ...
        /// <summary>
        ///     Returns true if MessagesApiSouthKoreaOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of MessagesApiSouthKoreaOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessagesApiSouthKoreaOptions input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessagesApiSouthKoreaOptions {\n");
        ...
        {
            return Equals(input as MessagesApiSouthKoreaOptions);
        }
