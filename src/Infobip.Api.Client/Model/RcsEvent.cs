...
namespace Infobip.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RcsEvent")]
    [JsonObject]
    public class RcsEvent : IEquatable<RcsEvent>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="RcsEvent" /> class.
        /// </summary>
        ...
        ///     Initializes a new instance of the <see cref="RcsEvent" /> class.
        /// </summary>
        /// <param name="sender">Identifier of an RCS sender that will be used to send event. (required).</param>
        /// <param name="destinations">
        ///     An array of destination objects for where the event is being sent. A valid destination is
        ///     required. (required).
        /// </param>
        /// <param name="content">content (required).</param>
        /// <param name="options">options.</param>
        public RcsEvent(string sender = default, List<RcsToDestination> destinations = default,
            RcsOutboundEventContent content = default, RcsEventOptions options = default)
        {
        ...
        /// </summary>
        /// <value>Identifier of an RCS sender that will be used to send event.</value>
        ...
        /// </summary>
        /// <value>An array of destination objects for where the event is being sent. A valid destination is required.</value>
        ...
        public List<RcsToDestination> Destinations { get; set; }
        ...
        public RcsOutboundEventContent Content { get; set; }
        ...
        public RcsEventOptions Options { get; set; }

        /// <summary>
        ///     Returns true if RcsEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of RcsEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RcsEvent input)
        {
            if (input == null)
                return false;
        ...
        {
            return Equals(input as RcsEvent);
        }
