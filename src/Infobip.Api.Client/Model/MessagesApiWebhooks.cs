...
namespace Infobip.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MessagesApiWebhooks")]
    [JsonObject]
    public class MessagesApiWebhooks : IEquatable<MessagesApiWebhooks>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="MessagesApiWebhooks" /> class.
        /// </summary>
        ...
        ///     included here will also be automatically included in the message Delivery Report and Seen Report. The maximum value
        ///     is 4000 characters..
        /// </param>
        /// <param name="seen">seen.</param>
        public MessagesApiWebhooks(MessagesApiDelivery delivery = default, string contentType = default,
            string callbackData = default, MessagesApiSeenStatusReporting seen = default)
        {
            Delivery = delivery;
        ...
        public MessagesApiDelivery Delivery { get; set; }
        ...
        ///     be automatically included in the message Delivery Report and Seen Report. The maximum value is 4000 characters.
        /// </summary>
        /// <value>
        ///     Additional data that can be used for identifying, managing, or monitoring a message. Data included here will
        ///     also be automatically included in the message Delivery Report and Seen Report. The maximum value is 4000
        ///     characters.
        /// </value>
        ...
        public MessagesApiSeenStatusReporting Seen { get; set; }

        /// <summary>
        ///     Returns true if MessagesApiWebhooks instances are equal
        /// </summary>
        /// <param name="input">Instance of MessagesApiWebhooks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessagesApiWebhooks input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessagesApiWebhooks {\n");
        ...
        {
            return Equals(input as MessagesApiWebhooks);
        }
