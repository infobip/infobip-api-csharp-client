...
namespace Infobip.Api.Client.Model
{
    ...
    ///     WebhookMessageCount
    /// </summary>
    [DataContract(Name = "WebhookMessageCount")]
    [JsonObject]
    public class WebhookMessageCount : IEquatable<WebhookMessageCount>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="WebhookMessageCount" /> class.
        /// </summary>
        ...
        ///     request..
        /// </param>
        public WebhookMessageCount(int messageCount = default, int pendingMessageCount = default)
        {
        ...
        /// <summary>
        ///     Returns true if WebhookMessageCount instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookMessageCount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookMessageCount input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WebhookMessageCount {\n");
        ...
        {
            return Equals(input as WebhookMessageCount);
        }
