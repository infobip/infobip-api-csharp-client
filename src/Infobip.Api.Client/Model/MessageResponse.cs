...
namespace Infobip.Api.Client.Model
{
    ...
    [JsonObject]
    public class MessageResponse : IEquatable<MessageResponse>
    {
        /// <summary>
        ...
        ///     (required).
        /// </param>
        public MessageResponse(string bulkId = default, List<MessageResponseDetails> messages = default)
        {
        ...
        public List<MessageResponseDetails> Messages { get; set; }
        ...
        {
            return Equals(input as MessageResponse);
        }
