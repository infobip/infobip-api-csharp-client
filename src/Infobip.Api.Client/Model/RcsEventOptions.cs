...
namespace Infobip.Api.Client.Model
{
    ...
    ///     Event options.
    /// </summary>
    [DataContract(Name = "RcsEventOptions")]
    [JsonObject]
    public class RcsEventOptions : IEquatable<RcsEventOptions>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="RcsEventOptions" /> class.
        /// </summary>
        /// <param name="platform">platform.</param>
        /// <param name="deliveryTimeWindow">deliveryTimeWindow.</param>
        public RcsEventOptions(Platform platform = default, DeliveryTimeWindow deliveryTimeWindow = default)
        {
            Platform = platform;
        ...
        /// <summary>
        ///     Returns true if RcsEventOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of RcsEventOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RcsEventOptions input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RcsEventOptions {\n");
        ...
        {
            return Equals(input as RcsEventOptions);
        }
