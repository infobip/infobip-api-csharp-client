...
namespace Infobip.Api.Client.Model
{
    ...
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="EmailWebhookTrackResponse" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <param name="input">Instance of EmailWebhookTrackResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailWebhookTrackResponse input)
        {
            if (input == null)
                return false;
        ...
        {
            return Equals(input as EmailWebhookTrackResponse);
        }
