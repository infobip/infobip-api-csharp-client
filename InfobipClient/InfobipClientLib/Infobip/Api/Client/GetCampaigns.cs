...
namespace Infobip.Api.Client
{
    ...
    {
        private static string path = "/omni/1/campaigns";
        ...
        public async Task<CampaignsResponse> ExecuteAsync(GetCampaignsExecuteContext context)
        {
            using (var client = HttpClientProvider.GetHttpClient(configuration))
            {
                ...
                {
                    return JsonConvert.DeserializeObject<CampaignsResponse>(contents, Settings);
                }
                else
                {
