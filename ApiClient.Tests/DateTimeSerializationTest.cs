...
public class DateTimeSerializationTest
{
    ...
    {
        new(2035, 8, 18, 12, 8, 42, 777, new TimeSpan(0, 0, 0)),
        new(2035, 8, 18, 13, 8, 42, 777, new TimeSpan(1, 0, 0)),
        new(2035, 8, 18, 11, 8, 42, 777, new TimeSpan(-1, 0, 0)),
        new(2035, 8, 18, 17, 8, 42, 777, new TimeSpan(5, 0, 0)),
        new(2035, 8, 18, 7, 8, 42, 777, new TimeSpan(-5, 0, 0)),
        new(2035, 8, 18, 13, 38, 42, 777, new TimeSpan(1, 30, 0)),
        new(2035, 8, 18, 10, 38, 42, 777, new TimeSpan(-1, -30, 0)),
        new(2035, 8, 18, 17, 38, 42, 777, new TimeSpan(5, 30, 0)),
        new(2035, 8, 18, 6, 38, 42, 777, new TimeSpan(-5, -30, 0))
    };
